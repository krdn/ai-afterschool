...
<task type="auto">
  ...
  <action>
    ...
    8. src/app/(dashboard)/students/page.tsx - 임시 placeholder (Plan 05에서 완성):
...
2. 로그인 후 /students/new에서 학생 등록
3. 등록된 학생 상세 페이지(/students/[id])에서 정보 확인
4. 학생 정보 수정(/students/[id]/edit) 후 저장 확인
5. 학생 삭제 후 목록에서 제거됨 확인
6. 다른 선생님 계정으로 로그인 시 해당 학생 접근 불가 확인
</verification>
