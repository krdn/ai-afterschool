 ...
 * Help Content System
 *
 * Universal LLM Hub의 종합 도움말 콘텐츠를 정의합니다.
 */
...
const helpContent: HelpTopic[] = [
  // ========== Getting Started ==========
  {
    ...
    title: 'LLM Hub란?',
    summary: 'Universal LLM Hub는 여러 AI 제공자를 통합 관리하는 시스템입니다.',
    content: [
      '# LLM Hub란?',
      '',
      'Universal LLM Hub는 다양한 AI 언어 모델(LLM) 제공자를 하나의 시스템에서 통합 관리하는 플랫폼입니다.',
      '',
      '## 주요 기능',
      '',
